  ...
  return (
    <footer className="border-t border-border bg-card mt-auto">
      <div className="container py-12">
        ...
        <div className="border-t border-black-700 mt-8 pt-8 text-center text-sm text-black-400">
          {/* First line: Made with ❤️ by StaffArc */}
          ...
          {/* Second line: Pure Supply copyright */}
          <p className="mt-2">
            &copy; {new Date().getFullYear()} <strong>Pure Supply</strong>. All
            rights reserved.
          </p>
        </div>
      </div>
