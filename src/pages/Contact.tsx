        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">contact@elysianemporium.com</p>
              </CardContent>
            </Card>
            ...
            <div className="bg-primary text-primary-foreground p-6 rounded-lg">
              ...
              <p className="text-sm opacity-90">Monday - Saturday: 9:00 AM - 6:00 PM</p>
